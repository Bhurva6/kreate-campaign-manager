...
export default function CampaignCalendarPage() {
  ...
  // Sample images for the calendar posts
  const sampleImages = [
    "/bright-cereal.png",
    "/blue-cereal.png", 
    "/images.jpeg",
    "/ChatGpt-art-styleITG-1743494812804.avif",
    "/labubuastro.jpeg",
    "/girl1.jpeg",
    "/girl2.jpeg",
    "/girl3.jpeg",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center gap-4 mt-8">
            <button
              ...
              onClick={() => {
                // Could export calendar or save campaign
                console.log("Approve campaign schedule");
              }}
            >
              Approve Schedule
            </button>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <span className={`px-2 py-1 rounded-full text-xs font-semibold ${
                        selectedPost.approval.status === "Approved" 
                          ? "bg-green-500/20 text-green-400" 
                          : selectedPost.approval.status === "Pending Review"
